...
fs.writeFileSync(path.join(dir, 'ArticleSocialShare.tsx'), [
  "'use client';",
  "",
...
fs.writeFileSync(path.join(dir, 'ArticleFaqAccordion.tsx'), [
  "'use client';",
  "",
  "import React, { useState } from 'react';",
...
console.log('ALL BLOG SLUG FILES GENERATED SUCCESSFULLY!');